		...
		<section class="content">
			...
			<div class="panel panel-default">
				...
				<div class="row data-type">
					...
					<div class="col-md-2 title">出游人员</div>
					<div class="col-md-4 data">
						<input type="text" class="form-control" placeholder="出游人数"
							   value="${order.member.name}" readonly="readonly">
					</div>
					...
					<div class="col-md-4 data">
						<input type="text" class="form-control" placeholder="会员手机号"
							   value="${order.member.phoneNum}" readonly="readonly">
					...
					<div class="col-md-2 title" style="color: #00c0ef">
						<a href="${pageContext.request.contextPath}/orders/findById.do?id=${order.id}">查看详情</a>
					</div>
